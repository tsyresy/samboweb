...
export function Footer() {
  return (
    <footer className="border-t border-sambo-200/60 bg-sambo-900 text-sambo-100">
      <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6">
        <div className="flex flex-col gap-8 sm:flex-row sm:justify-between">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-2 text-sm text-sambo-200">
        ...
        <p className="mt-8 text-xs text-sambo-300">
